...
const OrderPage = () => {
  ...
  const diliveryPriceMemo = useMemo(() => {
    if(priceMemo >= 200000 && priceMemo < 300000){
      return 10000
    }else if(priceMemo >= 300000 || order?.orderItemsSelected?.length === 0) {
      return 0
    } else {
      return 20000
    }
  ...
  const itemsDelivery = [
    ...
    {
      title: '10.000 VND',
      description: 'Từ 200.000 VND đến dưới 300.000 VND',
    },
    {
      title: 'Free ship',
      description : 'Trên 300.000 VND',
    },
  ]
  return (
    <div style={{background: '#f5f5fa', with: '100%', height: '100vh'}}>
      <div style={{height: '100%', width: '100%', margin: '-2% auto 0'}}>
        <h2 style={{fontWeight: 'bold', margin: '30px 8% 0'}}>Giỏ hàng</h2>
